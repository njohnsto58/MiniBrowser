...
public class MiniMiniBrowser extends JFrame implements HyperlinkListener {
  ...
  public static void main(String[] args) {
      // http://oradocs-corp.documents.us2.oraclecloud.com
    MiniMiniBrowser browser = new MiniMiniBrowser();
